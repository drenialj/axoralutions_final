...
import { Code, Brain, Eye, Network } from 'lucide-react';

const services = [
  {
    icon: <Brain className="w-8 h-8" />,
    title: 'GPT & LLM Integration',
    description: 'Integration und Anpassung großer Sprachmodelle für Ihre spezifischen Anwendungsfälle.',
    features: [
  ...
  },
  {
    ...
    title: 'NLP & Textanalyse',
    description: 'Entwicklung maßgeschneiderter Lösungen für die Verarbeitung und Analyse von Textdaten.',
    features: [
      'Sentiment Analysis',
  ...
  },
  {
    ...
    description: 'Implementierung von Bildverarbeitungs- und Erkennungssystemen für Ihre Anforderungen.',
    features: [
      'Objekt-Erkennung',
      'Bildklassifikation',
      'Gesichtserkennung',
  ...
  },
  {
    ...
    description: 'Entwicklung und Training spezialisierter KI-Modelle für Ihre spezifischen Anwendungsfälle.',
    features: [
      'Datenvorbereitung',
      'Modellarchitektur',
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            Maßgeschneiderte KI-Lösungen für Ihre spezifischen Anforderungen
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 rounded-2xl" />
            <div className="relative z-10">
              <h2 className="text-3xl font-bold mb-4">Bereit für Ihre maßgeschneiderte KI-Lösung?</h2>
